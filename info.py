...
PICS = (environ.get('PICS' ,'https://graph.org/file/01ddfcb1e8203879a63d7.jpg 74394.jpg 8e932.jpg ')).split()
BOT_START_TIME = time()
...
START_MESSAGE = environ.get('START_MESSAGE', '👋 𝙷𝙴𝙻𝙾 {user}\n\n𝙼𝚈 𝙽𝙰𝙼𝙴 𝙸𝚂 {bot},\n𝙸'm an AWESOME AUTO + MANUAL FILTER BOT I CAN PROVIDE ALL MOVIES/SERIES INSTANTLY..')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Team_Netflix1')
